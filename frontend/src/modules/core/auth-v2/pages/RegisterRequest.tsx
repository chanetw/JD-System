/**
 * Register Request Page for V2 Auth System
 *
 * Registration form that submits request for admin approval.
 * User will be created with PENDING status and isActive = false.
 */
...
const RegisterRequest: React.FC = () => {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
    ...
    setFormData((prev) => ({
      ...prev,
      [name]: name === 'departmentId' || name === 'tenantId' ? (value ? Number(value) : null) : value,
    }));
