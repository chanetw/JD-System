...
> - อธิบายทุกคำสั่งที่เขียน ภาษาไทย
> - Implement Plan ที่สร้างเป็นไทย
> - Walkthrough Plan ที่สร้างเป็นไทย
> - คำภาษาอังกฤษ (Technical Terms) ต้องตีความเป็นภาษาไทยกำกับไว้
> - ใช้ JSDoc format สำหรับ Function Header
> - ใช้ inline comment สำหรับอธิบายแต่ละบรรทัด อธิบายภาษาไทย ตัวแปรสำคัญ วิธีการทำงาน
